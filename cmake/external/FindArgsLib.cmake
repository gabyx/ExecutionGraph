...
if(NOT EXISTS "${args_INCLUDE_DIR}")
    ...
    find_path(
        args_INCLUDE_DIR
        NAMES args.hxx
        DOC "Args library header files" PATH ${args_DIR})
endif()
...
if(NOT EXISTS "${args_INCLUDE_DIR}")
    ...
    set(args_INCLUDE_DIR
        ${args_SOURCE_DIR}
        CACHE PATH "args library (${URL}) include directory" FORCE)
    set(args_DIR
        "${args_INCLUDE_DIR}"
        CACHE PATH "args library directory" FORCE)
