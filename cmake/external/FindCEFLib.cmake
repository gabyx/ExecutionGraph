...
if(NOT EXISTS ${CEF_ROOT})
    ...
    if("${CMAKE_SYSTEM_NAME}" STREQUAL "Darwin")
        set(CEF_DSYM_URL "http://opensource.spotify.com/cefbuilds/cef_binary_3.3282.1741.gcd94615_macosx64_debug_symbols.tar.bz2")
    ...
    if(${ExecutionGraph_USE_CEF_DSYM_FILE} AND (NOT ${CEF_DSYM_URL}  STREQUAL ""))
        download_project(PROJ               "cefbinaries-dsymfile"
                        PREFIX              "${ExecutionGraph_EXTERNAL_BUILD_DIR}/cefbinaries"
                        URL                 ${CEF_DSYM_URL}
                        UPDATE_DISCONNECTED 1)
