...
if(NOT EXISTS "${meta_INCLUDE_DIR}")
    ...
    message(
        STATUS
            "meta library: inlcude dir not found -> download from https://github.com/ericniebler/meta.git"
    )
    ...
    download_project(
        ...
        GIT_TAG master
        GIT_SHALLOW ON
        UPDATE_DISCONNECTED 1 CMAKE_ARGS -DCMAKE_CXX_COMPILER=${CMAKE_CXX_COMPILER}
                            -DCMAKE_CXX_FLAGS=${CMAKE_CXX_FLAGS})

    set(meta_INCLUDE_DIR
        "${meta_SOURCE_DIR}/include"
        CACHE PATH "meta library (https://github.com/ericniebler/meta.git) include directory" FORCE)
    # define a path in the cache where to find this downloaded library (for cmake find_package)
    set(meta_DIR
        "${meta_SOURCE_DIR}"
        CACHE PATH "meta library directory" FORCE)
