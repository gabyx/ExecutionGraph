...
import * as NS14255453238270099840 from "@eg/serialization/GraphTypeDescription_generated";
/**
 * @constructor
 */
 ...
 */
graphsTypes(index: number, obj?:NS14255453238270099840.executionGraph.serialization.GraphTypeDescription):NS14255453238270099840.executionGraph.serialization.GraphTypeDescription|null {
  var offset = this.bb!.__offset(this.bb_pos, 4);
  return offset ? (obj || new NS14255453238270099840.executionGraph.serialization.GraphTypeDescription).__init(this.bb!.__indirect(this.bb!.__vector(this.bb_pos + offset) + index * 4), this.bb!) : null;
};
