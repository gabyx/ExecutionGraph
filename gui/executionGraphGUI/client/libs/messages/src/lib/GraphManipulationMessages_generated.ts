...
import * as NS578127928888604879 from "@eg/serialization/SocketLink_generated";
 ...
 */
socketLink(obj?:NS578127928888604879.executionGraph.serialization.SocketLink):NS578127928888604879.executionGraph.serialization.SocketLink|null {
  var offset = this.bb!.__offset(this.bb_pos, 6);
  return offset ? (obj || new NS578127928888604879.executionGraph.serialization.SocketLink).__init(this.bb_pos + offset, this.bb!) : null;
};
