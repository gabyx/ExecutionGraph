...
import * as NS13654391355974986681 from "./GraphTypeDescription_generated";
/**
 * @constructor
 */
 ...
 */
graphsTypes(index: number, obj?:NS13654391355974986681.executionGraphGUI.serialization.GraphTypeDescription):NS13654391355974986681.executionGraphGUI.serialization.GraphTypeDescription|null {
  var offset = this.bb!.__offset(this.bb_pos, 4);
  return offset ? (obj || new NS13654391355974986681.executionGraphGUI.serialization.GraphTypeDescription).__init(this.bb!.__indirect(this.bb!.__vector(this.bb_pos + offset) + index * 4), this.bb!) : null;
};
