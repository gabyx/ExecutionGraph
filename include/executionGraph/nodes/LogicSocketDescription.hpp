...
namespace executionGraph
{
    ...
    */
    ...
    template<typename TData, IndexType Idx>
...
#define EXECGRAPH_DEFINE_INPUT_DESCR(descName, TData, Idx, name) \
    static constexpr auto descName = makeInputDescription<TData, Idx>(name);

#define EXECGRAPH_DEFINE_OUTPUT_DESCR(descName, TData, Idx, name) \
    static constexpr auto descName = makeOutputDescription<TData, Idx>(name);
