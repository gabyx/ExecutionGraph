...
#ifndef FLATBUFFERS_GENERATED_SOCKETLINKDESCRIPTION_EXECUTIONGRAPH_SERIALIZATION_H_
#define FLATBUFFERS_GENERATED_SOCKETLINKDESCRIPTION_EXECUTIONGRAPH_SERIALIZATION_H_
...
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(8) SocketLinkDescription FLATBUFFERS_FINAL_CLASS {
 private:
  uint64_t outNodeId_;
 ...
 public:
  SocketLinkDescription() {
    memset(this, 0, sizeof(SocketLinkDescription));
  }
  SocketLinkDescription(uint64_t _outNodeId, uint64_t _outSocketIdx, uint64_t _inNodeId, uint64_t _inSocketIdx, bool _isWriteLink)
...
FLATBUFFERS_STRUCT_END(SocketLinkDescription, 40);

}  // namespace serialization
}  // namespace executionGraph

#endif  // FLATBUFFERS_GENERATED_SOCKETLINKDESCRIPTION_EXECUTIONGRAPH_SERIALIZATION_H_
