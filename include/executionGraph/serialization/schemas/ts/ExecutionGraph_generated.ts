...
import * as NS265933416849523758 from "./cpp/executionGraph/serialization/schemas/";
import * as NS8768211991854589814 from "./cpp/executionGraph/serialization/schemas/";
import * as NS14255453238270099840 from "./cpp/executionGraph/serialization/schemas/";
/**
 * @enum
 */
 ...
 */
links(index: number, obj?:NS578127928888604879.executionGraph.serialization.SocketLink):NS578127928888604879.executionGraph.serialization.SocketLink|null {
  var offset = this.bb!.__offset(this.bb_pos, 8);
  return offset ? (obj || new NS578127928888604879.executionGraph.serialization.SocketLink).__init(this.bb!.__vector(this.bb_pos + offset) + index * 40, this.bb!) : null;
};
