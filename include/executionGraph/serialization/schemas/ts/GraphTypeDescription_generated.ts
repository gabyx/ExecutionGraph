...
import * as NS9272066980085565115 from "@serialization/NodeTypeDescription_generated";
import * as NS2894054599977824968 from "@serialization/SocketTypeDescription_generated";
/**
 * @constructor
 */
...
socketTypeDescriptions(index: number, obj?:NS2894054599977824968.executionGraph.serialization.SocketTypeDescription):NS2894054599977824968.executionGraph.serialization.SocketTypeDescription|null {
  ...
  return offset ? (obj || new NS2894054599977824968.executionGraph.serialization.SocketTypeDescription).__init(this.bb!.__indirect(this.bb!.__vector(this.bb_pos + offset) + index * 4), this.bb!) : null;
};
...
nodeTypeDescriptions(index: number, obj?:NS9272066980085565115.executionGraph.serialization.NodeTypeDescription):NS9272066980085565115.executionGraph.serialization.NodeTypeDescription|null {
  ...
  return offset ? (obj || new NS9272066980085565115.executionGraph.serialization.NodeTypeDescription).__init(this.bb!.__indirect(this.bb!.__vector(this.bb_pos + offset) + index * 4), this.bb!) : null;
};
