...
import * as NS4383457487000119878 from "./cpp/executionGraph/serialization/schemas/";
import * as NS14310979851724692393 from "./cpp/executionGraph/serialization/schemas/";
/**
 * @constructor
 */
 ...
 */
socketTypeDescriptions(index: number, obj?:NS14310979851724692393.executionGraph.serialization.SocketTypeDescription):NS14310979851724692393.executionGraph.serialization.SocketTypeDescription|null {
  var offset = this.bb!.__offset(this.bb_pos, 8);
  return offset ? (obj || new NS14310979851724692393.executionGraph.serialization.SocketTypeDescription).__init(this.bb!.__indirect(this.bb!.__vector(this.bb_pos + offset) + index * 4), this.bb!) : null;
};
 ...
 */
nodeTypeDescriptions(index: number, obj?:NS4383457487000119878.executionGraph.serialization.NodeTypeDescription):NS4383457487000119878.executionGraph.serialization.NodeTypeDescription|null {
  var offset = this.bb!.__offset(this.bb_pos, 10);
  return offset ? (obj || new NS4383457487000119878.executionGraph.serialization.NodeTypeDescription).__init(this.bb!.__indirect(this.bb!.__vector(this.bb_pos + offset) + index * 4), this.bb!) : null;
};
