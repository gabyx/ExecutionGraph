...
import * as NS13873119913449574917 from "./DataTypes_generated";
/**
 * @constructor
 */
...
static createNodeVisualization(builder:flatbuffers.Builder, nodeId:flatbuffers.Long, positionOffset:flatbuffers.Offset):flatbuffers.Offset {
  NodeVisualization.startNodeVisualization(builder);
  NodeVisualization.addNodeId(builder, nodeId);
...
static createLinkVisualization(builder:flatbuffers.Builder, socketOffset:flatbuffers.Offset):flatbuffers.Offset {
...
static createGraphVisualization(builder:flatbuffers.Builder, workspaceVisualizationOffset:flatbuffers.Offset, nodeVisualizationOffset:flatbuffers.Offset, linkVisualizationOffset:flatbuffers.Offset):flatbuffers.Offset {
