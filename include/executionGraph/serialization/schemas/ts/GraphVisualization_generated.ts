...
import * as NS578127928888604879 from "./cpp/executionGraph/serialization/schemas/";
import * as NS14965100849554803941 from "./cpp/executionGraph/serialization/schemas/";
/**
 * @constructor
 */
 ...
 * @returns Box2f|null
 */
box(obj?:NS14965100849554803941.Box2f):NS14965100849554803941.Box2f|null {
  var offset = this.bb!.__offset(this.bb_pos, 6);
  return offset ? (obj || new NS14965100849554803941.Box2f).__init(this.bb_pos + offset, this.bb!) : null;
};
 ...
 */
position(obj?:NS14965100849554803941.Vector2d):NS14965100849554803941.Vector2d|null {
  var offset = this.bb!.__offset(this.bb_pos, 6);
  return offset ? (obj || new NS14965100849554803941.Vector2d).__init(this.bb_pos + offset, this.bb!) : null;
};
 ...
 */
socket(obj?:NS578127928888604879.executionGraph.serialization.SocketLink):NS578127928888604879.executionGraph.serialization.SocketLink|null {
  var offset = this.bb!.__offset(this.bb_pos, 4);
