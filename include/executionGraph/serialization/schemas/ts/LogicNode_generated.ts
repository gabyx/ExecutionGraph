...
import * as NS12877220878556032826 from "@serialization/LogicSocket_generated";
/**
 * @constructor
 */
...
inputSockets(index: number, obj?:NS12877220878556032826.executionGraph.serialization.LogicSocket):NS12877220878556032826.executionGraph.serialization.LogicSocket|null {
  ...
  return offset ? (obj || new NS12877220878556032826.executionGraph.serialization.LogicSocket).__init(this.bb!.__indirect(this.bb!.__vector(this.bb_pos + offset) + index * 4), this.bb!) : null;
};
